...
function MenuCheckboxItem({
	...
	return (
		<MenuPrimitive.CheckboxItem
			checked={checked}
			className={cn(
				"grid in-data-[side=none]:min-w-[calc(var(--anchor-width)+1.25rem)] cursor-default grid-cols-[1fr_1rem] items-center gap-2 rounded-sm py-1 px-2 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-accent data-highlighted:text-accent-foreground data-disabled:opacity-64 sm:text-sm [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
				className,
			)}
		...
		>
			...
			<MenuPrimitive.CheckboxItemIndicator className="col-start-2 flex items-center justify-center">
	...
	return (
		...
		>
			<MenuPrimitive.RadioItemIndicator className="col-start-1">
				<span className="inline-flex w-1.5 h-1.5 rounded-full items-center justify-center bg-accent" />
